...
def inference(
    ...
    print(data_path_and_name_and_type_new)
...
cmd={'model_type': 'pytorch', 'ngpu': 0, 'log_level': 'ERROR', 'audio_in':audio_in, 'name_and_type': ['speech', 'sound', model_path+'am.mvn'], 'asr_model_file': model_path+'model.pb', 'idx_text': '', 'sampled_ids': 'seq2seq/sampled_ids', 'sampled_lengths': 'seq2seq/sampled_lengths', 'lang': 'zh-cn', 'code_base': 'funasr', 'mode': 'paraformer', 'fs': {'audio_fs': 16000, 'model_fs': 16000}, 'beam_size': 1, 'penalty': 0.0, 'maxlenratio': 0.0, 'minlenratio': 0.0, 'ctc_weight': 0.0, 'lm_weight': 0.0, 'asr_train_config': model_path+'config.yaml', 'lm_file': model_path+'lm.pb', 'lm_train_config': model_path+'config_lm.yaml', 'batch_size': 1, 'frontend_conf': {'fs': 16000, 'win_length': 400, 'hop_length': 160, 'window': 'hamming', 'n_mels': 80, 'lfr_m': 7, 'lfr_n': 6}, 'token_num_relax': None, 'decoding_ind': None, 'decoding_mode': None, 'num_workers': 0,'device':'cuda'} #GPU设置'device':'cuda' CPU设置'device':'cpu'
